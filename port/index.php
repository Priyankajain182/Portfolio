...
<div class="social-links mt-3 text-center">
      ...
      if($data['instagram']!=""){
       ...
       if($data['skype']!=""){
            ?>
                    <a href="<?=$data['skype']?>" class="google-plus"><i class="bx bxl-skype"></i></a>
                    <?php
        }
      if($data['linkedin']!=""){
            ?>
      ...
      if($data['github']!=""){
        ...
        <br>
        <br>
        <div class="email"style="font-size: 10.75px;">
                            <h6><button type="button" onclick="myFunction()" class="btn btn-light btn-sm">Last edited</button></h6>
                                <p id="demo1"></p>
                                <script>
                                    document.getElementById("demo1").innerHTML = document.lastModified;
                                </script>   
                            </div>
                            <div class="phone"style="font-size: 10.75px;">
                                <h6>Device Size</h6>
...
-->
            <div class="credits">
                Copyright ©2021 
                All rights reserved | 
                Developed by <a href="#">Priyanka Jain</a>
            </div>
        </div>
    </footer><!-- End  Footer -->
